    ...
    <div class="dash">
        <div class="dash-nav dash-nav-dark">
            <header>
                ...
                <a href="index.php" class="spur-logo"><i class="fas fa-bolt"></i> <span>Cash for Trash</span></a>
            </header>
            <nav class="dash-nav-list">
                ...
                <div class="dash-nav-dropdown">
                    ...
                    <div class="dash-nav-dropdown-menu">
                        <a href="https://github.com/Rayanchupranaykumar" target="_blank" class="dash-nav-dropdown-item">GitHub</a>
                        <a href="https://www.linkedin.com/in/pranay-kumar-rayanchu/" target="_blank" class="dash-nav-dropdown-item">LinkedIn</a>
                    </div>
                </div>
            </nav>
        </div>
        <div class="dash-app">
            <header class="dash-toolbar">
                ...
                <a class="btn btn-warning btn-xl text-uppercase" href="login.php" style="border-radius: 10%;">Login</a>
                    <a href="https://github.com/Rayanchupranaykumar" target="_blank" class="tools-item">
                        <i class="fab fa-github"></i>
                    </a>
                    <a href="https://www.linkedin.com/in/pranay-kumar-rayanchu/" target="_blank" class="tools-item">
                        <i class="fab fa-linkedin"></i>
                    </a>
                    <a href="https://twitter.com/pranay_divine" target="_blank" class="tools-item">
                        ...
                        <div class="col-xl-4">
                            <div class="stats stats-danger">
                                ...
                                <div class="stats-content d-flex flex-row-reverse">
                                    <div class="stats-icon">
                                        <a href="mailto:rayanchupranay@gmail.com" style="color: inherit; text-decoration: none;" target="_blank"><i class="fa-solid fas fa-envelope"></i></a>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-xl-6">
                            <div class="card spur-card">
                                <div class="card-header">
                                    ...
                                    <div class="spur-card-title"> Cash for Trash </div>
                                </div>
                                <div class="card-body ">
